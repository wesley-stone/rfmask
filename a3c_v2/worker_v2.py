from a3c_v2.a3c_v2 import AC_Network

from tf_utils import *
from a3c_v2.painter_v2 import *
import time
...
class Worker(object):
    def __init__(self, name,s_size,trainer,model_path,global_episodes, data_type, data_path, max_episode_num = 10, debug=False):
        ...
        self.local_AC = AC_Network(s_size, self.name, trainer, debug=debug)
        ...
        with sess.as_default(), sess.graph.as_default():
            while not coord.should_stop():
                ...
                while d:
                    ...
                    episode_buffer.append([s,m,r,s1,d,v[0,0]])
