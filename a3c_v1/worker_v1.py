from a3c.a3c_v1 import AC_Network

from tf_utils import *
from a3c.painter_v1 import *
...
class Worker(object):
    def __init__(self, name,s_size,trainer,model_path,global_episodes, data_type, data_path, max_episode_num = 10):
        ...
        self.local_AC = AC_Network(s_size, self.name, trainer, debug=False)
    ...
    def __fold(self, pos):
        offset_h = self.local_AC.input_h-self.local_AC.map_size[0]
        offset_w = self.local_AC.input_w-self.local_AC.map_size[1]
        y = pos//self.local_AC.map_size[1] + offset_h//2
        x = pos%self.local_AC.map_size[1] + offset_w//2

        return y, x, y*1.0/self.local_AC.input_h, x*1.0/self.local_AC.input_w
